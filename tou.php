...
<?php
$bodytext = _("By using this website, you accept the following:<br/>").
            "<ul>".
            sprintf(_("<li>You will become a %s member by registering</li>"),Config::get('assocname')).
            _("<li>This website uses cookies if you choose to use the &quot;Remember me&quot; functionality</li>").
            "</ul>";
